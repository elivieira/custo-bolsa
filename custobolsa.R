...
custo.bolsa <- function(titulo, mes, ano) {
  ...
  for (i in (ano-aa):ano) {
    for (j in 1:length(row.names(x))) {
      if (i < 1995) {
        stop("Não dispomos de dados anteriores a 1995.")
      }

      ### Valor das bolsas de jan/1995 a jan/2004
      if ((i >= 1995) & (i <= 2004)) {
        if ((j > keymonth) & (i == ano) | (i == ano - aa) & (j <= keymonth)) {
          x[j,as.character(i)] <- 0 
        }
        else {
          if (aa==2) {
            x[j,as.character(i)] <- 724.52
          }
          else {
            x[j,as.character(i)] <- 1072.89
          }
        }
      }
      ...
      if ((i == 2004) & (j > 1) | (i > 2004) & (i <= 2006)) {
        ...
        if ((j > keymonth) & (i == ano) | (i == ano - aa) & (j <= keymonth)) {
          ...
          if (aa == 2) {
            x[j,as.character(i)] <- 855
          }
          else {
            x[j,as.character(i)] <- 1267.89
          }
        }
      }
      ...
      if((i == 2006) & (j > 6) | (i > 2006) & (i <= 2008)) {
        if((j > keymonth) & (i == ano) | (i == ano - aa) & (j <= keymonth)) {
          ...
          if (aa == 2) {
            x[j,as.character(i)] <- 940
          }
          else {
            x[j,as.character(i)] <- 1340 
          }
        }
      }
      ...
      if((i == 2008) & (j > 5) | (i > 2008) & (i <= 2012)) {
        if ((j > keymonth) & (i == ano) | (i == ano - aa) & (j <= keymonth)) {
          ...
          if (aa == 2) {
            x[j,as.character(i)] <- 1200
          }
          else {
            x[j,as.character(i)] <- 1800
          }
        }
      }
      ...
      if ((i == 2012) & (j > 6) | (i == 2013)) {
        if ((j > keymonth) & (i == ano) | (i = =ano - aa) & (j <= keymonth)) {
          ...
          if (aa == 2) {
            x[j,as.character(i)] <- 1350
          }
          else {
            x[j,as.character(i)] <- 2000
          }
        }
      }
      ...
      if((i == 2013) & (j > 3) | (i > 2013)) {
        if ((j > keymonth) & (i == ano) | (i == ano - aa) & (j <= keymonth)) {
          ...
          if (aa == 2) {
            x[j,as.character(i)] <- 1500
          }
          else {
            x[j,as.character(i)] <- 2200
          }
        }
      }
    }
